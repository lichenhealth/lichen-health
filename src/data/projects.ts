...
export const projects: Project[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { title: 'Philanthropic Model', img: `${WP}/2026/01/country.svg`, body: ["With a clear path to self-sustainability via member subscriptions, our 501c3 Nonprofit is poised to pass donations through to network members, which makes donating to Lichen compelling for those passionate about immediate impact. Because 100% of our technological infrastructure is focused on supporting members in collaborating with each other, we are well positioned to foster efficiency across the network."] },
      { title: 'Land Trust', img: `${WP}/2026/01/Group-4700.svg`, body: ["Lichen owned and operated facilities are in full service of the community, with calendar integrations that allow local practitioners, communities and groups to book spaces and services via the app. If network members require resources to restore, protect or maintain the land on which they offer healing to the community, donations and/or revenue is passed through to the land steward via the Lichen Land Trust."] },
    ],
  ...
  },
  {
    ...
    sections: [
      ...
      { title: 'Community', img: `${WP}/2026/01/Group-4670-2.svg`, body: ["Inspired by the efficiency and wisdom of the Fibonacci Spiral, each Community, Group, Organization and Place that decides to use the platform enjoys their own, complete ecosystem, which includes all of the features of the greater network. The platform even allows you to spin out your own progressive web application, so members can access you via the Lichen App, or via your owned and operated app."] },
      { title: 'Concierge', img: `${WP}/2026/01/Group-4726.svg`, body: ["The Concierge utility provides a safe, secure and private ecosystem within the Lichen app, where practitioners can collaborate to deliver the next, best intervention on your journey of healing, growth and transformation. Integrated with Lichen's chat feature, communication is easy and seamless.", "Lichen providers take turns being on-call for urgent care needs, ensuring members get support while avoiding practitioner burnout. Each member also has an optional AI Assistant to synthesize information, answer questions and connect you with the information you need to unlock your own inner wisdom."] },
    ],
